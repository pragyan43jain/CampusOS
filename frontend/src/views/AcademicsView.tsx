...
export const AcademicsView: React.FC<AcademicsViewProps> = ({ courses }) => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'marks' | 'study-tools'>('marks');
  ...
  const getPerformanceFeedback = (percentage: number) => {
    if (percentage >= 75) {
      return {
        ...
        feedback: 'Great job! On track for S/A grade. Maintain this consistency for the FAT final exam.',
      ...
      return {
        level: 'warning',
        badge: '⚠ Do Better',
        feedback: 'Do better: You are currently between 50% and 75%. Prioritize upcoming assignments and CAT-2 to lift your internal score into the A/S range.',
      ...
      return {
        level: 'critical',
        badge: '🚨 You Need to Work Hard',
        feedback: 'You need to work hard: Marks are below 50%. Schedule consultation with faculty and utilize the Study Tools below immediately to avoid grade penalties.',
    ...
    <div className="page-content">
      ...
      <div className="section-header" style={{ flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
            VTOP continuous assessment tracking, performance feedback, and interactive study tools.
          </p>
        </div>
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-md)', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <span style={{ fontSize: '0.88rem', fontWeight: 700, color: 'var(--text-secondary)' }}>Select Course:</span>
          <select
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
                  ...
                  {stats && (
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                        Scored: {stats.scored} / {stats.max} marks
                      </span>
                    </div>
                  )}
                </div>
                      ...
                      <tbody>
                        ...
                        {course.marks.da1 && (
                          <tr>
                            ...
                            <td style={{ color: 'var(--success-emerald)', fontWeight: 700 }}>{course.marks.da1.scored}</td>
                        ...
                        {course.marks.quiz && (
                          <tr>
                            ...
                            <td style={{ color: 'var(--success-emerald)', fontWeight: 700 }}>{course.marks.quiz.scored}</td>
