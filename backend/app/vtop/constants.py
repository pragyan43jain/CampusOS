...
OD_CANDIDATES = [
    ...
    ("processViewStudentODHistory", "semester", True),
    ("processViewStudentAttendanceOD", "semester", True),
    ...
    ("academics/common/StudentODView", "od", True),
    ...
    ("students/processViewStudentOD", "semester", True),
    ...
    ("leave/viewStudentODHistory", "semester", True),
    ...
    ("leave/processViewStudentOD", "semester", True),
    ("leave/processViewStudentODDetails", "semester", True),
    ("leave/doStudentODView", "semester", True),
